;(function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        highlightMatched: true, //TODO highlight the matched chars in the dropdown
        maxHeight: '300px',
        autoComplete: false,
        dataName: null,
        minChars: 1,
    ...
    $.extend(Plugin.prototype, {
        ...
        _createSuggestions: function (filteredArray) {
            ...
            if (this.settings.absolutePos) {
                this.suggestionsDiv.addClass('absolute');
            } else {
                this.suggestionsDiv.removeClass('absolute');
            }
